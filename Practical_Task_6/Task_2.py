...
def spisok(tutors, groups):
    my_list = [(tutors[i], groups[i]) if i < len(groups) else (tutors[i],None) for i in range(len(tutors))]
    return my_list


print(spisok(tutors_1, groups_1))
print(spisok(tutors_2, groups_2))